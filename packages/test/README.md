...
- [@safepaste/guard](https://www.npmjs.com/package/@safepaste/guard) — Runtime security middleware for AI agent pipelines. Wraps tool functions to scan inputs/outputs for attacks across 13 categories.
